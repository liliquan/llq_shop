                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            {{ csrf_field() }}
                                <fieldset>
                                    <ul>
                                        <li class="frame_style form_error"><label class="user_icon"></label><input name="username"
                                                type="text" id="username" tishi="用户名" /><i>用户名</i></li>
                                        <li class="frame_style form_error"><label class="password_icon"></label><input
                                                name="password" tishi="密码" type="password" id="userpwd" /><i>密码</i></li>
    ...
    $('#login_btn').on('click', function () {
        ...
        $("input[type$='text'],input[type$='password']").each(function (n) {
            if ($(this).val() == "") {
                ...
                layer.alert(str += "" + $(this).attr("tishi") + "不能为空！\r\n", {
                    title: '提示框',
                    icon: 0,
                });
                num++;
