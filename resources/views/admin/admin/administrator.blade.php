...
<div class="page-content clearfix">
	...
	<tbody>
     ...
     <tr>
      ...
      <td class="td-manage">
		...
		<!-- onclick="member_del(this,'1')"   删除提示框 -->
        <a title="删除" href="{{ route('delete_adminer',['id'=>$v->id]) }}" onclick="return confirm('确定要删除吗？');" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
	   </td>
	 </tr>
	 @endforeach 
 ...
 <div id="add_administrator_style" class="add_menber" style="display:none">
    <form action="{{ route('add_adminer') }}" method="post" id="form-admin-add">
	{{ csrf_field() }}
