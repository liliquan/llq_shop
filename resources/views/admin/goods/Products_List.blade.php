 ...
 <div id="products_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="/admin/add_goods" title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
       ...
       <table class="table table-striped table-bordered table-hover" id="sample-table">
		<thead>
		 <tr>
				...
				<th width="100px">SKU名称</th>
				<th width="100px">SKU值</th>
    ...
    @foreach($data as $v)
     <tr>
        ...
        <td width="100px">{{ $v->sku_name }}</td>
        <td width="100px">{{ $v->sku_value }}</td>
        <td width="100px">{{ $v->stock }}</td> 
        <td width="100px">{{ $v->price }}</td>         
        <td width="180px">{{ $v->created_at }}</td>
        <td class="text-l"><img src="{{ $v->logo }}" width="120px" alt=""></td>
