...
<body>
    <div class="clearfix" id="add_picture">
        ...
        <div class="page_right_style">
            ...
            <form action="{{ route('insert_goods') }}" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-article-add">
                @csrf
                <div class="clearfix cl">
                    <label class="form-label col-2"><span class="c-red"></span>产品标题：</label>
                    <div class="formControls col-10"><input type="text" class="input-text" name="goods_name"></div>
                </div>
                <div class="clearfix cl">
                    <label class="form-label col-2"><span class="c-red"></span>产品价格：</label>
                    <div class="formControls col-10"><input type="text" name="goods_price"></div>
                </div>
                ...
                <div class="clearfix cl">
                    ...
                    一级分类：
                    <select name="colId_1" id="catid" class="required">
                        @foreach($data as $v)
                        <option value="{{ $v->id }}">{{ $v->class_name }}</option>
                        @endforeach
                    </select>

                    <select name="colId_2" class="required">
                                    
                    </select>

                    <select name="colId_3" class="required">
                ...
                <div class="clearfix cl">
                    ...
                    <input name="logo" id="logo" class="clearfix" type="file">
                        <td>
                            <!-- 显示原图 -->
                            ...
                            <div class="docs-preview">
                                <div class="img-preview preview-lg" name="lg_logo"></div>
                                <div class="img-preview preview-md" name="md_logo"></div>
                                <div class="img-preview preview-sm" name="sm_logo"></div>
                            </div>
                        </td>
                </div>
                ...
                <div class="clearfix cl">
                    ...
                    <div class="formControls col-10" name="desc">
                ...
                <div class="clearfix cl">
                    ...
                    <div id="sku-container">
                        ...
                        sku值：<input type="text" name="sku_value[]">
                        库存量：<input type="text" name="stock[]">
                        价格：<input type="text" name="price[]">
                        <input type="button" value="添加一个sku" id="add_sku">
                    </div>
                </div>
                ...
                <div class="clearfix cl">
                    ...
                    <div id="attr-container">
                        ...
                        属性值：<input type="text" name="attr_value[]">
                        <input type="button" value="添加一个属性" id="add_attr">
                    </div>
                 ...
                 <div class="clearfix cl">
                    ...
                    <div id="img-container">
                        <td>
                            <div></div>
                            <input type="button" value="添加一张图片" id="add_img"> 
                            <input name="many_logo[]" class="clearfix" type="file">
                        </td>
                    </div>
                </div>
                <br>
    ...
    <script>
        ...
        // 三级联动
        $("select[name=colId_1]").change(function(){
            // 取出这个分类的id
            var id = $(this).val()
            // 如果不为空就执行AJAX
            if(id!="")
            {
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        $("select[name=colId_2]").html(str)
                        // 触发第二个框的 change 事件
                        $("select[name=colId_2]").trigger('change');
                    }
                });
            }
        });
        ...
        $("select[name=colId_2]").change(function(){
            // 取出这个分类的id
            var id = $(this).val()
            // 如果不为空就执行AJAX
            if(id!="")
        ...
        var attrStr =
            `<hr>
                <div class="clearfix cl">
                    <label class="form-label col-2">添加属性：</label>
                    属性名称：<input type="text" name="attr_name[]">
                    属性值：<input type="text" name="attr_value[]">
                </div>`
        ...
        var imgStr = `<input name="many_logo[]" class="clearfix" type="file">`
