...
<div class="clearfix">
 ...
 <div class="Ads_list">
    <div class="border clearfix">
       <span class="l_f">
        <a href="/admin/add_article"  title="添加文章" id="add_page" class="btn btn-warning"><i class="fa fa-plus"></i> 添加文章</a>
       ...
       <thead>
        ...
        <tbody>
         <tr>
          ...
          <td>显示</td>
          <td class="td-manage">   
           <a title="编辑" onclick="member_edit('编辑','/admin/add_article','4','','510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
