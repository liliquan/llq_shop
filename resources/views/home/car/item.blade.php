        ...
        <div id="item">
            ...
            <!--product-info-->
                ...
                <div class="product-info">
                    <div class="fl preview-wrap">
                        ...
                        <div class="zoom">
                            ...
                            <div id="preview" class="spec-preview">
                                <span class="jqzoom"><img jqimg="{{ $image_one->logo }}" src="{{ $image_one->logo }}" /></span>
                            </div>
                            <!--下方的缩略图-->
                            <div class="spec-scroll">
                                ...
                                <div class="items">
                                    <ul>
                                        @foreach($image as $v)
                                        <img src="{{ $v->path }}" bimg="{{ $v->path }}" onmousemove="preview(this)"
                                            width="50px">
                                        @endforeach
                                    </ul>
                                </div>
                    ...
                    <form action="/home/add_car?id={{$goods->id}}" method="post">
                        @csrf
                            ...
                            <div class="clearfix choose">
                                <div id="specification" class="summary-wrap clearfix">
                                    ...
                                    <dl>
                                        ...
                                        <dd name="fa_dd">
                                            <input type="hidden" name="sku_value[]" class="sku_v">
                                        </dd>

                                        <dd>
                                            @foreach($v->sku_value as $k=>$c)
                                                <a href="javascript:;" name="sku_status" @if($k==0) class="selected" @endif> {{ $c }}</a>
                                            @endforeach
                                        </dd>
                                ...
                                <div class="summary-wrap">
                                    <div class="fl title">
                                        <div class="control-group">
                                            <div class="controls">
                                                <input id="min" class="increment mins" type="button" value="-" />    
                                                <input id="quantity" name="shuliang" type="text" class="itxt" value="1" />    
                                                <input id="add" class="increment plus" type="button" value="+" />    
                                            </div>
                                        </div>
                                    </div>
                                    <div class="fl">
                                        <ul class="btn-choose unstyled">
                                            <li>
                                                <input type="submit" class="sui-btn  btn-danger addshopcar" value="加入购物车">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
