                ...
                <div class="py-container">
                    <div class="shortcut">
                        <ul class="fl">
                            ...
                            <li class="f-item">请
                                <a href="{{ route('home_login') }}" target="_blank">登录</a>　
                                <span><a href="{{ route('regist') }}" target="_blank">免费注册</a></span>
                            </li>
                        </ul>
                        <ul class="fr">
        ...
        <div class="py-container">
            <div class="yui3-g SortList ">
                <div class="yui3-u Left all-sort-list">
                    ...
                    @foreach($one as $v)
                        <div class="item bo">
                            <h3><a href="">{{ $v->class_name }}</a></h3>
                            <div class="item-list clearfix">
                                <div class="subitem">
                                @foreach($two as $v2)
                                <?php if($v->id == $v2->parent_id){ ?>
                                    <dl class="fore1">
                                        <dt><a href="">{{ $v2->class_name }}</a></dt>
                                        <dd>
                                            @foreach($three as $v3)
                                            <?php if($v2->id == $v3->parent_id){ ?>
                                                <em><a href="{{ route('search',['id'=>$v3->id]) }}">{{ $v3->class_name }}</a></em>
                                            <?php }?>
                                            @endforeach
                                        </dd>
