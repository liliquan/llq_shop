                ...
                <div class="py-container">
                    <div class="shortcut">
                        <ul class="fl">
                            ...
                            <li class="f-item">请<a href="{{ route('home_login') }}" target="_blank">登录</a>　<span><a href="register.html"
    ...
    <div class="goods-list">
        <ul class="seckill" id="seckill">
            <li class="seckill-item">
                <div class="pic" onclick="location.href='{{ route('seckill_item') }}'">
                ...
                <a class='sui-btn btn-block btn-buy' href="{{ route('seckill_item') }}" target='_blank'>立即抢购</a>
            </li>
            <li class="seckill-item">
                <div class="pic">
                    <img src="/img/_/list.jpg" alt=''>
