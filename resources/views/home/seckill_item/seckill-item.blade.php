			...
			<div class="py-container">
				<div class="shortcut">
					<ul class="fl">
						...
						<li class="f-item">请<a href="{{ route('home_login') }}" target="_blank">登录</a>　<span><a href="register.html" target="_blank">免费注册</a></span></li>
					</ul>
					<ul class="fr">
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="{{ route('cart') }}" target="_blank" class="sui-btn  btn-danger addshopcar">立即抢购</a>
									</li>
								</ul>
							</div>
						</div>
