                ...
                <div class="py-container">
                    <div class="shortcut">
                        <ul class="fl">
                            ...
                            <li class="f-item">请<a href="{{ rote('login') }}" target="_blank">登录</a>　<span><a href="{{ route('regist') }}"
                                        target="_blank">免费注册</a></span></li>
                        </ul>
                        <ul class="fr">
                            <li class="f-item">我的订单</li>
                            <li class="f-item space"></li>
                            <li class="f-item"><a href="{{ route('home') }}" target="_blank">我的品优购</a></li>
                            <li class="f-item space"></li>
        ...
        <div class="yui3-g home">
            ...
            <div class="yui3-u-1-6 list">
                ...
                <div class="list-items">
                    <dl>
                        <dt><i>·</i> 订单中心</dt>
                        <dd><a href="{{ route('home') }}" class="list-active">我的订单</a></dd>
                        <dd><a href="{{ route('wait_pay') }}">待付款</a></dd>
                        <dd><a href="{{ route('wait_send') }}">待发货</a></dd>
                        <dd><a href="{{ route('wait_receive') }}">待收货</a></dd>
                        <dd><a href="{{ route('wait_evaluate') }}">待评价</a></dd>
                    </dl>
                    <dl>
                        <dt><i>·</i> 我的中心</dt>
                        <dd><a href="{{ route('collect') }}">我的收藏</a></dd>
                        <dd><a href="{{ route('footmark') }}">我的足迹</a></dd>
                    </dl>
                    <dl>
                        <dt><i>·</i> 物流消息</dt>
                    </dl>
                    <dl>
                        <dt><i>·</i> 设置</dt>
                        <dd><a href="{{ route('info') }}">个人信息</a></dd>
                        <dd><a href="{{ route('address') }}">地址管理</a></dd>
                        <dd><a href="{{ route('safe') }}">安全管理</a></dd>
                    </dl>
                </div>
            </div>
            <!--右侧主内容-->
                    ...
                    <div class="tab-content ">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="pwdid" class="fn-tinput" data-rule-remote="http://www.baidu.com"
                                            type="password" name="OldPassword" placeholder="输入昵称" required
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="fn-tinput" type="password" name="password" value="" placeholder="新密码"
                                            required id="password" data-rule-remote="php.php">
                                    </div>
                                </div>
                                <div class="control-group">
                        ...
                        <div id="two" class="tab-pane active">
                            ...
                            <div class="sui-steps steps-auto">
                                <div class="wrap">
                                    <div class="finished">
                                        <label><span class="round"><i class="sui-icon icon-pc-right"></i></span><span>第一步
                                                验证身份</span></label><i class="triangle-right-bg"></i><i class="triangle-right"></i>
                                    </div>
                                </div>
                                <div class="wrap">
                                    <div class="finished">
                                        <label><span class="round"><i class="sui-icon icon-pc-right"></i></span><span>第二步
                                                绑定新手机号</span></label><i class="triangle-right-bg"></i><i class="triangle-right"></i>
                                    </div>
                                </div>
                            ...
                            <div class="overed">
                                <div class="content">
                                    ...
                                    <div class="text">
                                        ...
                                        <p class="back"><a href="{{ route('home') }}">返回首页</a></p>
                                    </div>
                                </div>
