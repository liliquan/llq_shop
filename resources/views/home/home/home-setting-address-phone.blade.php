                ...
                <div class="py-container">
                    <div class="shortcut">
                        <ul class="fl">
                            ...
                            <li class="f-item">请<a href="{{ route('login') }}" target="_blank">登录</a>　<span><a href="{{ route('regist') }}"
                    ...
                    <div class="tab-content ">
                        ...
                        <div id="two" class="tab-pane active">
                            ...
                            <div class="sui-steps steps-auto">
                                ...
                                <div class="wrap">
                                    <div class="current">
                                        <label><span class="round">2</span><span>第二步 绑定新手机号</span></label><i class="triangle-right-bg"></i><i
